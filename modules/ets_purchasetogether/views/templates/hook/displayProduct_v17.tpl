    ...
    {if isset($purchase_togethers) && $purchase_togethers && count($purchase_togethers) != $alldisabled}
        ...
        {block name="purchase_together"}
            ...
            {if (isset($configs.ETS_PT_EXCLUDE_CURRENT_PRODUCT) && !$configs.ETS_PT_EXCLUDE_CURRENT_PRODUCT) 
                ...
                <li class="item-product ">
                    ...
                    <div class="ets_purchase_item_des">
                        <label for="product_{$currProduct.id|intval}_{$currProduct.id_product_attribute|intval}">{l s='This current product' d='Shop.Theme'} (<b>{$currProduct.name}</b>)</label>
                        ...
                        {block name='product_price_and_shipping'}
                            {if $currProduct.show_price && isset($configs.ETS_PT_DISPLAY_PRODUCT_PRICE) && $configs.ETS_PT_DISPLAY_PRODUCT_PRICE}
                                <span class="product-price-and-shipping">
                                    ...
                                    <span itemprop="price" class="price">{$currProduct.price}</span>
                            ...
                            {/if}
                        {/block}
                        <p class="attribute_small this-product">{if isset($currProduct.attribute_small) && $currProduct.attribute_small}{$currProduct.attribute_small}{/if}</p>
                        ...
                        <div class="row-product">
                            <div class="ets_purchase_item_image">
                                <input type="checkbox" class=""
                                    ...
                                    data-qty="{if isset($configs.ETS_PT_DEFAULT_QUANTITY_ADDED_TO_CART) && $configs.ETS_PT_DEFAULT_QUANTITY_ADDED_TO_CART}{$configs.ETS_PT_DEFAULT_QUANTITY_ADDED_TO_CART}{else}1{/if}"
                            ...
                            <div class="ets_purchase_item_des">
                                <label for="purchase_{$product.id_product|intval}_{$product.id_product_attribute|intval}">
                                      <span class="product-title"><a href="{$product.url}">{$product.name_attribute|truncate:100:'...'}</a></span>
                                </label>
                                {block name='product_price_and_shipping'}
                                    ...
                                    {/if}
                                {/block}
                                <p class="attribute_small">{if isset($product.attribute_small) && $product.attribute_small}{$product.attribute_small}{/if}</p>
        	...
        	<div class="button-container {if count($purchase_togethers) == $alldisabled}disabled{/if}">
        		<a class="ets_ajax_add_to_cart_button btn btn-primary" href="{$ajax_cart}" rel="nofollow" title="{l s='Add all to cart' d='Shop.Theme'}">
...
{else}
    {if isset($purchase_togethers) && $purchase_togethers && count($purchase_togethers) != $alldisabled}
        ...
        {block name="purchase_together"}
                        ...
                        <div class="row-product">
                            <div class="ets_purchase_item_image">
                                ...
                                {block name='product_thumbnail'}
                                    <a href="{$currProduct.url}" class="thumbnail product-thumbnail">
                                      <img
                                        src = "{$currProduct.cover.bySize.small_default.url}"
                                        alt = "{$currProduct.cover.legend}"
                                        data-full-size-image-url = "{$currProduct.cover.small.url}"
                                      >
                                    </a>
                                {/block}     
                            </div>
                            <div class="ets_purchase_item_des">
                                <label for="product_{$currProduct.id|intval}_{$currProduct.id_product_attribute|intval}">{l s='This product' d='Shop.Theme'} (<b>{$currProduct.name}</b>)</label>
                                {block name='product_price_and_shipping'}
                                    {if $currProduct.show_price && isset($configs.ETS_PT_DISPLAY_PRODUCT_PRICE) && $configs.ETS_PT_DISPLAY_PRODUCT_PRICE}
                                        <span class="product-price-and-shipping">
                                            {*if $currProduct.has_discount}
                                ...
                                <div class="ets_purchase_item_image">
                                    ...
                                    <a href="{$product.url}" class="thumbnail product-thumbnail">
                                      <img
                                        ...
                                        data-full-size-image-url = "{$product.cover.small.url}"
                                      >
                                    </a>
                                    {/block}
                                </div>
        	...
        	<div class="button-container {if count($purchase_togethers) == $alldisabled}disabled{/if}">
        		<a class="ets_ajax_add_to_cart_button btn btn-primary" href="{$ajax_cart}" rel="nofollow" title="{l s='Add all products to cart'}">
