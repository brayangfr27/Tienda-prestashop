<?php
/* Smarty version 3.1.43, created on 2022-09-08 22:04:08
  from 'C:\wamp64\www\tienda_prestashop\themes\ebusiness\modules\ets_multilayerslider\views\templates\hook\multilayerslider.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.43',
  'unifunc' => 'content_631aad28a19b81_26204000',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ed5bd1c1985250e7e075b57532d4b539bc58f7e6' => 
    array (
      0 => 'C:\\wamp64\\www\\tienda_prestashop\\themes\\ebusiness\\modules\\ets_multilayerslider\\views\\templates\\hook\\multilayerslider.tpl',
      1 => 1662167581,
      2 => 'file',
    ),
  ),
...
function content_631aad28a19b81_26204000 (Smarty_Internal_Template $_smarty_tpl) {
...
" style="<?php if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'])) && $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'LayoutHome1') {?>width: <?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['mls_width']->value), ENT_QUOTES, 'UTF-8');?>
px; height: <?php echo htmlspecialchars(intval($_smarty_tpl->tpl_vars['mls_height']->value), ENT_QUOTES, 'UTF-8');?>
px; <?php } else { ?> width: 1920px; height: 675px;<?php }?> <?php if ($_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BACKGROUND']) {?>background-color: <?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BACKGROUND'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
